class LostItemsController < ApplicationController
    ...
    def create
       ...
       respond_to do |format|
          if @lost_item.save
             format.html { redirect_to @lost_item, notice: 'lost_item was successfully created.' }
    ...
    def destroy
       @lost_item.destroy
          respond_to do |format|
          format.html { redirect_to lost_items_url, notice: 'lost_item was successfully destroyed.' }
    ...
    def lost_item_params
       params.require(:lost_item).permit(:name)
    end
 end